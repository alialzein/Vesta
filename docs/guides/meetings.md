...
- **Sidebar → Workspace → Meetings** (on the phone: the **Menu** tab → Meetings).
- Requires your mailbox connection with calendar access. If you connected
  before calendar access existed, the page will ask you to **Reconnect once**
...
Tap **Prep with Vesta** on any meeting and Vesta writes a one-page prep from
your own mailbox:

- **What's live** — what these attendees have emailed you about recently.
- **Still open** — unresolved asks and radar items with these people that
  this meeting could settle.
- **Worth asking** — sharp questions grounded in that history (never generic
  filler).

Honesty rules apply: the prep uses **only your real email history with these
attendees**. If there is none, it says exactly that instead of inventing
background. Each prep is one small AI call (visible in the admin AI page
under **prep**).
