...
const PATHS = {
  ...
  eyeOff: (
    <path d="M3 3l18 18M10.6 10.6a2 2 0 002.8 2.8M9.9 4.2A9.8 9.8 0 0112 4c5 0 9 4 9 8a9.7 9.7 0 01-1.7 2.9M6.1 6.1A9.8 9.8 0 003 12c0 4 4 8 9 8 1.2 0 2.3-.2 3.3-.6" />
  ),
  people: (
    <>
...
/** The Google "G" mark (brand colors). Decorative; aria-hidden. */
export function GoogleLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 48 48" aria-hidden="true" {...props}>
      <path
        fill="#FFC107"
        d="M43.6 20.5H42V20H24v8h11.3c-1.6 4.7-6.1 8-11.3 8a12 12 0 010-24c3.1 0 5.9 1.2 8 3.1l5.7-5.7A20 20 0 1024 44c11 0 20-8 20-20 0-1.3-.1-2.3-.4-3.5z"
      />
      <path
        fill="#FF3D00"
        d="M6.3 14.7l6.6 4.8A12 12 0 0124 12c3.1 0 5.9 1.2 8 3.1l5.7-5.7A20 20 0 006.3 14.7z"
      />
      <path
        fill="#4CAF50"
      ...
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3a12 12 0 01-4.1 5.6l6.2 5.2C39.8 40 44 34 44 24c0-1.3-.1-2.3-.4-3.5z"
      />
    </svg>
  );
}
