 ...
 * the app redirects to /login. Light/dark safe; reduced-motion safe (the spinner
 * uses the shared animate-spin-slow class, disabled under prefers-reduced-motion).
 */
    ...
    <>
      ...
      {pending && (
        <div
          ...
          className="fixed inset-0 z-[200] grid place-items-center bg-[color:var(--bg)]/85 backdrop-blur-[3px]"
        >
